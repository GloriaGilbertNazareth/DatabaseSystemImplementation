...
char *tpch_dir ="data/tpch-dbgen/"; // /media/gloria/Work/UniversityOfFlorida/Study/SemII/DBI/Projects/Project2/Part1/a2test/data dir where dbgen tpch files (extension *.tbl) can be found
char *dbfile_dir = "bin/"; 
