...
extern char *catalog_path = "catalog"; // full path of the catalog file
extern char *dbfile_dir = "/media/gloria/Work/UniversityOfFlorida/Study/SemII/DBI/Projects/Project1/bin/"; // dir where binary heap files should be stored
extern char *tpch_dir ="/media/gloria/Work/UniversityOfFlorida/Study/SemII/DBI/Projects/Project1/data/tpch-dbgen/"; // dir where dbgen tpch files (extension *.tbl) can be found
